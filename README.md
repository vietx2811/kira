...
<p align="center">
  <a href="https://github.com/vietx2811/kira/releases/tag/v1.1.0"><strong>Download KIRA 1.1.0</strong></a>
  ·
...
- Contextual Kira Dock assistance and optional AI vision tagging for reference images.
- Version checkpoints and branches for exploring directions without losing earlier work.

## Quick start

KIRA 1.1.0 is currently released for Apple Silicon Macs.

1. Download [`KIRA-1.1.0-macos-arm64.zip`](https://github.com/vietx2811/kira/releases/download/v1.1.0/KIRA-1.1.0-macos-arm64.zip).
...
The included script creates an ad-hoc signature for use on the machine that runs it. It also supports a Developer ID identity; see [`packaging/macos/HUONG-DAN.md`](packaging/macos/HUONG-DAN.md). The public 1.1.0 release is not notarized by Apple.
