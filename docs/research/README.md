...
| 2026-09-16 | [2026-09-16-figma-ui3-reference.md](2026-09-16-figma-ui3-reference.md) | Figma UI3: ngôn ngữ thiết kế và bố cục làm tham chiếu "2026 hơn" cho KIRA | Bài học lớn nhất: Figma thử panel nổi rồi rút lại; KIRA đã dính mép nên đúng hướng. Bảng áp dụng/không áp dụng theo 12 surface, không xung đột Ink & Paper |
| 2026-09-16 | [2026-09-16-tailwind-kit-migration.md](2026-09-16-tailwind-kit-migration.md) | Đưa KIRA sang Tailwind v4 + shadcn/ui hoặc Untitled UI React: kỹ thuật, chi phí, rủi ro, kế hoạch pha | Phát hiện: nghiên cứu gốc 6/2026 (`docs/RESEARCH.md`) từng chọn shadcn+Tailwind rồi bị bỏ dở, không có doc giải thích. Đối lập trực tiếp với kết luận Ark UI cùng ngày — user cần chọn một hướng. Nếu chọn Tailwind: khuyến nghị shadcn/ui (không Untitled UI), pha 1 = Settings |
| 2026-09-16 | [2026-09-16-art-direction-v3-kit-directions.md](2026-09-16-art-direction-v3-kit-directions.md) | Art direction vòng 3: 4 hướng Ink & Paper / shadcn / Untitled UI / Figma UI3 trên 4 màn, dark và light (specimen `art-direction/v3/index.html`) | Đề xuất B lai (shadcn nova làm nền, mật độ UI3, giọng Ink & Paper). Chờ user chốt 7 quyết định §F |
