...
| 2026-09-14 | [2026-09-14-art-direction-controls-v2.md](2026-09-14-art-direction-controls-v2.md) | Art direction vòng 2: 3 tính cách control (Machined, Ink & Paper, Lens), tool rail icon có khối, nguồn icon (specimen trong `art-direction/v2/`) | Khuyến nghị Ink & Paper + icon rail vẽ riêng; 5 quyết định chờ user |
